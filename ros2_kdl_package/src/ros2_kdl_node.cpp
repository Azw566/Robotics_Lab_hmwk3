...
public:
          ...
          node_handle_(std::shared_ptr<Iiwa_pub_sub>(this))
    {
        ...
        declare_parameter("trajectory_len", 50);
        ...
        RCLCPP_INFO(get_logger(), "Total time: '%f'", this->total_time);
        RCLCPP_INFO(get_logger(), "Trajectory length: '%d'", this->trajectory_len);
        RCLCPP_INFO(get_logger(), "Kp: '%f'", this->Kp);
        ...
        RCLCPP_INFO(get_logger(), "Lambda value in case of null-space control: '%f'", this->lambda_);
        ...
        RCLCPP_INFO(get_logger(), "The acceleration duration is: '%f'", acc_duration);
        RCLCPP_INFO(get_logger(), "The trajectory duration is: '%f'", traj_duration);
